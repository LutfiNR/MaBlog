<!-- Main article showcasing the last article -->
<div class="w-full inline-block">
    <article class="flex flex-col items-start justify-end mx-5 sm:mx-10 relative h-[60vh] sm:h-[85vh]">
        
        <!-- Gradient background overlay to enhance the visual appeal -->
        ...
        <!-- Image of the last article, positioned behind other content -->
        ...
        <div
            ...
            <a href="article/<?=$data['lastArticle']['slug']?>" class='mt-6'>
                <!-- Title of the last article with a gradient effect on hover -->
                <h1 class='font-manrope font-bold capitalize text-lg sm:text-xl md:text-3xl lg:text-4xl'>
                    ...
                    dark:to-accentDark/50 hover:bg-[length:100%_6px] bg-left-bottom bg-no-repeat transition-[background-size] duration-500 '>
                        <?=$data['lastArticle']['title']?>
                    </span>
                </h1>
            </a>

            <!-- Description of the last article, hidden on small screens -->
...
<section
    ...
    <div class="grid grid-cols-2 grid-rows-2 gap-6 mt-10 sm:mt-16">
        ...
        <!-- Other featured posts displayed smaller -->
